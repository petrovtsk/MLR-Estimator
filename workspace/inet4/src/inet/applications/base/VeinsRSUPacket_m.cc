...
VeinsRSUPacket::VeinsRSUPacket() : ::inet::FieldsChunk()
{
}

VeinsRSUPacket::VeinsRSUPacket(const VeinsRSUPacket& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
uint32_t VeinsRSUPacket::getSequenceNumber() const
{
    return this->sequenceNumber;
}

void VeinsRSUPacket::setSequenceNumber(uint32_t sequenceNumber)
{
    handleChange();
...
VeinsRSUPacketDescriptor::VeinsRSUPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::VeinsRSUPacket)), "inet::FieldsChunk")
{
...
unsigned int VeinsRSUPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        0,    // FIELD_casOdoslania
        0,    // FIELD_firstSent
        FD_ISEDITABLE,    // FIELD_posX
        FD_ISEDITABLE,    // FIELD_posY
        FD_ISEDITABLE,    // FIELD_sequence
        FD_ISEDITABLE,    // FIELD_prikaz
        FD_ISEDITABLE,    // FIELD_visID
        FD_ISEDITABLE,    // FIELD_approaching
    };
...
const char *VeinsRSUPacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "omnetpp::simtime_t",    // FIELD_casOdoslania
        "omnetpp::simtime_t",    // FIELD_firstSent
        "double",    // FIELD_posX
        "double",    // FIELD_posY
        "string",    // FIELD_sequence
        "int",    // FIELD_prikaz
        "int",    // FIELD_visID
        "bool",    // FIELD_approaching
    };
...
std::string VeinsRSUPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_casOdoslania: return simtime2string(pp->getCasOdoslania());
        ...
        case FIELD_sequence: return oppstring2string(pp->getSequence());
        case FIELD_prikaz: return long2string(pp->getPrikaz());
        case FIELD_visID: return long2string(pp->getVisID());
        case FIELD_approaching: return bool2string(pp->getApproaching());
        default: return "";
    }
}
...
bool VeinsRSUPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_sequence: pp->setSequence((value)); return true;
        case FIELD_prikaz: pp->setPrikaz(string2long(value)); return true;
        case FIELD_visID: pp->setVisID(string2long(value)); return true;
        case FIELD_approaching: pp->setApproaching(string2bool(value)); return true;
